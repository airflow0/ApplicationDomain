...
$journal->execute();
$journalCount = $journal->rowCount() + 1;
$status = 0;
...
$stmt->bindValue(":referenceID", $journalCount);
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#addLineSubmit').click(function(){
                ...
                var accountcategory = $('#modalAddLine #accountCategoryOption').val();
                var addDebit = $('#modalAddLine #addDebit').val();
                var addCredit = $('#modalAddLine #addCredit').val();
                var addDescription = $('#modalAddLine #addDescription').val();
                var person =  $('#modalAddLine #addPerson').val();
            ...
            $('#editLine').click(function() {
                if(table.row('.selected').any())
                {
                    ...
                    $('#modalEditLine #editDebit').val(data[2]);
                    $('#modalEditLine #editCredit').val(data[3])
            ...
            $('#EditLineSubmit').click(function(){
                ...
                row[1] = $('#modalEditLine #accountCategoryOption').val();
                row[2] = $('#modalEditLine #editDebit').val();
                row[3] = $('#modalEditLine #editCredit').val();
                row[4] = $('#modalEditLine #editDescription').val();
                row.data().draw(false);
...
<div class="body-format" style="padding: 20px; color: #FFFFFF">
    ...
    <div class="d-flex justify-content-between" style="padding-bottom: 5px">
        ...
        <div class="p-2">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="<?php echo $journalCount; ?>" aria-label="#" aria-describedby="journal-no" disabled>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-start" style="padding-top: 5px; padding-bottom: 18px">
        <div class="p-2">
            ...
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#deleteLine">Delete line</button>
            ...
            <div class="modal-body bg-light">
                <form method="post" id="addJournalEntry" class="was-validated">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Debit" aria-label="accountName" aria-describedby="basic-addon1" id="addDebit" data-type='currency' >
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Debit" aria-label="accountName" aria-describedby="basic-addon1" id="addCredit" data-type='currency'>
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"></div>
                    </div>
            ...
            <div class="modal-body bg-light">
                <form method="post" id="addJournalEntry" class="was-validated">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Debit" aria-label="accountName" aria-describedby="basic-addon1" id="editDebit" data-type='currency' >
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Debit" aria-label="accountName" aria-describedby="basic-addon1" id="editCredit" data-type='currency'>
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"></div>
                    </div>
