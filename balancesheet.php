...
<div class="d-flex bd-highlight" style="margin-top: 100px;">
    ...
    <h3 class="p-2 flex-fill bd-highlight" style="text-align: center; color: white; font-family: sans-serif; font-weight: bold"> Balance Sheet</h3>


</div>

<h3 class="p-2 flex-fill bd-highlight" style="text-align: Left; color: white; font-family: sans-serif; font-weight: bold; margin-left:60px;"> Assets</h3>
...
<h3 class="p-2 flex-fill bd-highlight" style="text-align: Left; color: white; font-family: sans-serif; font-weight: bold; margin-left:60px;"> Liability</h3>
<div class="d-flex flex-column" style="margin-left: 50px; margin-right: 50px;">
    <div class="p-2">
        <table id="account_table" class="table table-dark">
            <thead>
...
<h3 class="p-2 flex-fill bd-highlight" style="text-align: Left; color: white; font-family: sans-serif; font-weight: bold; margin-left:60px;"> Equity</h3>
<div class="d-flex flex-column" style="margin-left: 50px; margin-right: 50px;">
    <div class="p-2">
        <table id="account_table" class="table table-dark">
            <thead>
